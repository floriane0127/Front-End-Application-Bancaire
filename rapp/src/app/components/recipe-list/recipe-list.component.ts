...
export class RecipeListComponent {
  ...
  constructor() {
    this.recipes = [
      new Recipe('Banana Bread', 'This is my favorite banana bread recipe! My mother taught me how to make this one warm summer afternoon',
     null, null, null),
     new Recipe('Homstead Tofu',
     'This is a dish from rural Hunan province in China and has tofu, some flavouring, and lots of chili pepers',
     null, null, null),
