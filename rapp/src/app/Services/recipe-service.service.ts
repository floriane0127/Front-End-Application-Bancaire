...
export class RecipeServiceService {
  ...
  public getAllRecipes(): Observable<any> {
    return this.http
    .get<Recipe>(RECIPE_SERVER + '/recipe/all');
  }
  ...
  public deleteRecipe(recipe: Recipe): Observable<any> {
    return this.http.delete<Recipe>(RECIPE_SERVER + '/recipe/' + recipe.id, this.httpOptions);
  }

  public getRecipeById(id: number): Observable<any> {
    return this.http.get<Recipe>(RECIPE_SERVER + '/recipe/findById/' + id);
  }
